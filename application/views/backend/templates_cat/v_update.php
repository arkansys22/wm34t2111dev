      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card card-primary">
            ...
            echo form_open_multipart('aspanel/produks_cat_update',$attributes); ?>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="custom-file">
                          ...
                          <label class="custom-file-label" for="exampleInputFile"><?php echo $rows['templates_cat_gambar'] ?></label>
                        </div>
                      </div>
                    </div>
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-primary" title="Batal" href="<?php echo base_url()?>aspanel/produks_cat"><i class="fab fa-creative-commons-sa"></i> Batal</a>
