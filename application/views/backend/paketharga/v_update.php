      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card card-primary">
            ...
            echo form_open_multipart('aspanel/paketharga_update',$attributes); ?>


              <div class="card-body">
                <div class="form-group">
                  <input type="hidden" name="paketharga_id" value="<?php echo $rows['paketharga_id'] ?>">
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Title</label>
                        <input type="text" class="form-control" name="paketharga_judul" value="<?php echo $rows['paketharga_judul'] ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="paketharga_meta_desk" value="<?php echo $rows['paketharga_meta_desk'] ?>">
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <!-- text input -->
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="row">
                        <img class="img-fluid mb-3" src="<?php echo base_url()?>assets/frontend/paketharga/<?php echo $rows['paketharga_gambar'] ?>" alt="Photo">
                      </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="custom-file">
                          ...
                          <label class="custom-file-label" for="exampleInputFile">Add Image <?php echo $rows['paketharga_gambar'] ?></label>
                        </div>
                      </div>
                    </div>
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-primary" title="Batal" href="<?php echo base_url()?>aspanel/paketharga"><i class="fab fa-creative-commons-sa"></i> Cancel</a>
